...
export class InitialSchema1783109122656 implements MigrationInterface {
  name = "InitialSchema1783109122656";
  ...
  // Destructive — drops all tables. Intended for local dev resets only, not
  // expected to run against a real environment.
